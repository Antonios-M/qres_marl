...
class DeepCentralisedMultiAgentActorCritic(PGAgent):
    ...
    def __init__(self, env, config, device):
        ...
        assert env.single_agent == False, "DCMAC only supports multi-agent environments"
        ...
        ## Neural networks
        n_outputs_actor = sum(self.n_agent_actions)
        n_outputs_critic = 1
        ...
        self.actor = ActorNetwork(
            self.actor_config["architecture"],
            reshaping=(self.n_agents, self.n_agent_actions[0]),
