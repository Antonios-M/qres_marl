...
class Quake_Res_10(gym.Env):

    def __init_quake_sim(self):
        in_buildings = gpd.read_file("../buildings_geo_data/toy_city_buildings_v_3.geojson")
        ...
        self.quake_IM_bldg_save_prefix = "toy_city_10_bldg_IM"
        self.quake_IM_road_save_prefix = "toy_city_10_road_IMs"
