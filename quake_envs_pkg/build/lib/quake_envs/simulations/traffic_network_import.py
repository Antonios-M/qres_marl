...
def import_network(network_file: str, demand_file: str, force_reprocess: bool = False):
    ...
    network_file_csv = PathUtils.traffic_processed_networks_folder / network_file_csv
    demand_file_csv = PathUtils.traffic_processed_networks_folder / demand_file_csv
